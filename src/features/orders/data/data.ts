import { type ReservationStatus } from './schema'

export const statusStyles = new Map<ReservationStatus, string>([
  [
    'pending',
...
export const statusOptions: { label: string; value: ReservationStatus }[] = [
